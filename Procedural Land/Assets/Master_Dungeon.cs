...
namespace Dungeon
{
    public class Master_Dungeon : MonoBehaviour
    {
        ...
        static void Main ()
        {
            ...
            Master_Dungeon.folder_name = System.IO.Directory.GetCurrentDirectory () + "\\" + "Assets\\" + "View\\" + date;
            ...
            foreach (Room item in list_room)
            {
        ...
        {
            string path = Master_Dungeon.folder_name + "/" + name;
            System.IO.File.WriteAllText (path, data);
            path = System.IO.Directory.GetCurrentDirectory () + "\\" + "Assets\\" + "View\\" + "current\\" + name;
            System.IO.File.WriteAllText (path, data);
        }
